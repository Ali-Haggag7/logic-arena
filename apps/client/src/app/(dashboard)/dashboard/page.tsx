    ...
    return (
        <div className="min-h-screen bg-bg-primary font-mono text-accent selection:bg-accent/30 relative overflow-hidden pb-12">
            ...
            <div className="max-w-5xl mx-auto pt-10 sm:pt-16 px-4 sm:px-6 relative z-20">
                <div className="mb-8 sm:mb-12 border-b border-accent/20 pb-4 sm:pb-6 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                    <div>
                        <h1 className="text-accent font-black text-3xl sm:text-4xl tracking-[0.15em] drop-shadow-[0_0_10px_rgba(var(--accent-rgb),0.5)] mb-2">
                            COMMAND CENTER
                        </h1>
                        <h2 className="text-accent/60 text-[10px] sm:text-xs tracking-widest uppercase flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 flex-col">
                    <div className="order-2 lg:order-1 lg:col-span-2 flex flex-col gap-4">
                        <div className="flex justify-between items-center mb-2">
                            <h3 className="text-accent/80 uppercase tracking-widest text-[10px] sm:text-xs font-bold">Neural Scripts Repository</h3>
                            <div className="flex items-center gap-4">
                                <CustomSelect
                                    value={selectedMode}
                                    onChange={(val) => setSelectedMode(val as any)}
                                />
                                <span className="text-text-secondary text-[10px]">TOTAL: {scripts.length}</span>
                            </div>
                        </div>
                        ...
                        {initialLoad ? (
                            ...
                            <div className="bg-bg-secondary/40 border border-accent/10 border-dashed rounded-lg p-8 sm:p-10 text-center text-text-secondary text-[10px] sm:text-sm tracking-wider">
