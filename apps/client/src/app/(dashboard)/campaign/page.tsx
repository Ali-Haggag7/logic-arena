          ...
          <div className="border-b border-accent/10 pb-7 mb-12">
            ...
            {!loading && (
              <div className="mt-5 flex items-center gap-4">
                <span className="text-[9px] tracking-[0.2em] text-accent/40">PROGRESS</span>
                ...
                <span className="text-[9px] tracking-[0.1em] text-accent/60 font-bold">
                      ...
                      <div className={`flex mb-6 ${isLeft ? "justify-start" : "justify-end"} relative z-10`}>
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-[9px] tracking-[0.3em] text-accent/40">
                          ...
                          <div
                            className={`text-[13px] font-black tracking-[0.18em] mb-2 leading-tight ${
                              level.completed ? "text-accent/50" : "text-accent"
                            }`}
                          ...
                          {/* Description */}
                          <p className="text-[9px] text-accent/35 tracking-[0.08em] mb-3 leading-relaxed">
                            {level.description}
                          </p>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-[9px] text-accent/45 tracking-[0.1em]">
                          ...
                          {isCurrent && (
                            <div className="absolute -top-2 left-1/2 -translate-x-1/2 text-[8px] tracking-[0.2em] text-accent bg-bg-primary px-2 py-0.5 border border-accent/40 rounded-full whitespace-nowrap">
                              CURRENT
                            </div>
                          )}
                        </button>
